        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsRecieved = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsRead = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecieverState", x => new { x.MessageId, x.Id });
                    table.ForeignKey(
                        name: "FK_RecieverState_Messages_MessageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecieverState_RecieverId",
                table: "RecieverState",
                column: "RecieverId");
